...
# working directory api.py is launched from (uvicorn backend.api:app vs
# uvicorn api:app both work this way).
sys.path.append(os.path.dirname(os.path.abspath(__file__)))
from explanation_layer import explain_payment
...
@app.get("/explain/{payment_id}")
def explain(payment_id: str):

    try:

        return explain_payment(payment_id)
